...
new_model = load_model("PredictionModels/Carrots4.h5")
...
new_model = load_model("PredictionModels/Coconut.h5")

dataSet = pd.read_csv('Datasets/Coconut.csv')

# splitting into training set and test set and converting to 2d numpy array
train = dataSet.iloc[:786, 1:2]
test = dataSet.iloc[786:, 1:2]
...
new_model = load_model("PredictionModels/Potatoes.h5")

dataSet = pd.read_csv('Datasets/Potatoes.csv')

# splitting into training set and test set and converting to 2d numpy array
train = dataSet.iloc[:680, 1:2]
test = dataSet.iloc[680:, 1:2]
